...
% uncomment line 52 to make individual model figures
...
obs = 'ERA5'; % 'ERSST5', 'COBE', 'AMIPII', 'ERA5', 'JRA55'
load([projects_output_dir,'observations_',varnam,'_',label,'_trend.mat'])
obs_trend = ERA5_trend; % ERSST5_trend, COBE_trend, AMIPII_trend, ERA5_trend, JRA55_trend
...
switch varnam
    ...
    case 'psl'
        trend_comparison_figures(LON_AXIS,LAT_AXIS,field2_trends_all,obs_trend,linspace(-240,240,25),linspace(-6,6,21),remove_GMSLP,'Multi-Model Ensemble',obs,label,trend_std_all);
end